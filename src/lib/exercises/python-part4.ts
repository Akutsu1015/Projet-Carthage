...
if age >= 18:
    print("Majeur")`,
      tests: [{ type: "contains", expected: "Majeur" }],
    },
    {
      id: "s1_e77",
...
if age >= 18:
    ...
    print("Mineur")`,
      tests: [{ type: "contains", expected: "Mineur" }],
    },
    {
      id: "s1_e78",
...
if note >= 90:
    ...
    print("Échec")`,
      tests: [{ type: "contains", expected: "Bien" }],
    },
    {
      id: "s1_e79",
...
if age >= 18 and revenus >= 2000:
    ...
    print("Crédit refusé")`,
      tests: [{ type: "contains", expected: "Crédit approuvé" }],
    },
    {
      id: "s1_e80",
...
if jour == "samedi" or jour == "dimanche":
    ...
    print("Jour de semaine")`,
      tests: [{ type: "contains", expected: "Weekend" }],
    },
    {
      id: "s1_e81",
...
if not connecte:
    ...
    print("Bienvenue")`,
      tests: [{ type: "contains", expected: "Veuillez vous connecter" }],
    },
    {
      id: "s1_e82",
...
if age >= 18:
    ...
    print("Trop jeune")`,
      tests: [{ type: "contains", expected: "Peut conduire" }],
    },
    {
      id: "s1_e83",
...
if couleur in couleurs_primaires:
    ...
    print("Couleur secondaire")`,
      tests: [{ type: "contains", expected: "Couleur primaire" }],
    },
    {
      id: "s1_e84",
...
if len(mot_de_passe) >= 8 and "1" in mot_de_passe:
    ...
    print("Invalide")`,
      tests: [{ type: "contains", expected: "Valide" }],
    },
    {
      id: "s1_e85",
...
for fruit in fruits:
    print(fruit)`,
      tests: [{ type: "contains", expected: "pomme" }],
    },
    {
      id: "s1_e87",
...
`,
    ...
    print(i)`,
      tests: [{ type: "contains", expected: "1" }],
    },
    {
      id: "s1_e88",
      title: "Boucle while",
...
for nombre in range(1, 11):
    somme += nombre
print(somme)`,
      tests: [{ type: "contains", expected: "somme += nombre" }]
    },
    {
      id: "s1_e90",
...
for nombre in nombres:
    if nombre == 5:
        print("Trouvé!")
        break`,
      tests: [{ type: "contains", expected: "Trouvé!" }],
    },
    {
      id: "s1_e91",
...
`,
    ...
    if i % 2 != 0:
        continue
    print(i)`,
      tests: [{ type: "contains", expected: "2" }],
    },
    {
      id: "s1_e92",
...
`,
    ...
    for j in range(1, 4):
        print(f"{i} x {j} = {i * j}")`,
      tests: [{ type: "contains", expected: "i * j" }]
    },
    {
      id: "s1_e93",
...
for index, animal in enumerate(animaux):
    print(f"{index}: {animal}")`,
      tests: [{ type: "contains", expected: "enumerate(" }]
    },
    {
      id: "s1_e94",
...
for lettre in mot:
    print(lettre)`,
      tests: [{ type: "contains", expected: "P" }],
    },
    {
      id: "s1_e95",
...
for i in range(1, 6):
    carres.append(i * i)
print(carres)`,
      tests: [{ type: "contains", expected: "i * i" }]
    },
  ];

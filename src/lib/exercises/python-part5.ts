...
saluer("Alice")`,
      tests: [{ type: "contains", expected: "Bonjour {nom}" }],
    },
    {
      id: "s1_e98",
...
resultat = doubler(5)
print(resultat)`,
      tests: [{ type: "contains", expected: "return nombre * 2" }],
    },
    {
      id: "s1_e99",
...
print(resultat)`,
      tests: [{ type: "contains", expected: "return a + b" }],
    },
    {
      id: "s1_e100",
...
print(puissance(4))
print(puissance(2, 3))`,
      tests: [{ type: "contains", expected: "def puissance(nombre, exposant=2):" }],
    },
    {
      id: "s1_e101",
...
test()
print(x)`,
      tests: [{ type: "contains", expected: "def test():\n    x = 5" }],
    },
    {
      id: "s1_e102",
...
print(aire_rectangle(5, 3))`,
      tests: [{ type: "contains", expected: '"""Calcule l\'aire d\'un rectangle"""' }],
    },
    {
      id: "s1_e103",
...
print(factoriel(4))`,
      tests: [{ type: "contains", expected: "def factoriel(n):" }],
    },
    {
      id: "s1_e104",
...
# Créez une fonction présenter(nom, age, ville)
...
print(carre(6))`,
      tests: [{ type: "contains", expected: "lambda x: x ** 2" }],
    },
...
print(carres)`,
      tests: [{ type: "contains", expected: "[x**2 for x in range(1, 6)]" }],
    },
    {
      id: "s1_e107",
...
print(personne["nom"])`,
      tests: [{ type: "contains", expected: '{"nom": "Alice", "age": 25, "ville": "Paris"}' }],
    },
    {
      id: "s1_e108",
...
print(list(notes.values()))`,
      tests: [{ type: "contains", expected: "print(list(notes.keys()))" }],
    },
    {
      id: "s1_e109",
...
`,
    ...
    print("Conversion impossible")`,
      tests: [{ type: "contains", expected: "except:" }],
    },
    {
      id: "s1_e110",
...
print(resultat)`,
      tests: [{ type: "contains", expected: "import math" }],
    },
    {
      id: "s1_e111",
...
print(moyenne(10, 15, 20))`,
      tests: [{ type: "contains", expected: "def moyenne(*nombres):" }],
    },
    {
      id: "s1_e112",
...
for i in compter(3):
    print(i)`,
      tests: [{ type: "contains", expected: "yield i" }],
    },
    {
      id: "s1_e113",
      title: "Classe simple",
...
print(ma_voiture.marque)`,
      tests: [{ type: "contains", expected: "class Voiture:" }],
    },
    {
      id: "s1_e114",
...
ma_voiture.demarrer()`,
      tests: [{ type: "contains", expected: "def demarrer(self):" }],
    },
    {
      id: "s1_e115",
...
with open('test.txt', 'r') as f:
    contenu = f.read()
    print(contenu)`,
      tests: [{ type: "contains", expected: "with open(" }],
    },
    {
      id: "s1_e116",
...
print("Prix: {:.2f}€".format(prix))`,
      tests: [{ type: "contains", expected: "{:.2f}" }],
    },
    {
      id: "s1_e117",
      title: "Set (ensemble)",
...
couleurs.add("bleu")
print(couleurs)`,
      tests: [{ type: "contains", expected: "couleurs = {" }],
    },
    {
      id: "s1_e118",
...
print(carres)`,
      tests: [
        { type: "contains", expected: "{x: x**2 for x in range(1, 6)}" },
      ],
    },
    {
      id: "s1_e119",
...
dire_hello()`,
      tests: [{ type: "contains", expected: "Appel de fonction" }],
    },
    {
      id: "s1_e120",
...
if choice == '1':
    ...
    print(f"Résultat: {divide(num1, num2)}")`,
      tests: [{ type: "contains", expected: "Calculatrice" }],
    },
  ];

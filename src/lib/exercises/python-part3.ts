...
print(a < b)
print(a > b)`,
      tests: [{ type: "contains", expected: "a == b" }],
    },
    {
      id: "s1_e52",
...
print(a or b)
print(not a)`,
      tests: [{ type: "contains", expected: "a and b" }],
    },
    {
      id: "s1_e53",
...
print(resultat)`,
      tests: [{ type: "contains", expected: "and salaire" }],
    },
    {
      id: "s1_e54",
      title: "Appartenance",
...
print(lettre not in voyelles)`,
      tests: [{ type: "contains", expected: " in voyelles" }],
    },
    {
      id: "s1_e55",
...
print(mot1 < mot2)
print(mot1 > mot2)`,
      tests: [{ type: "contains", expected: "mot1 == mot2" }],
    },
...
print(fruits)
print(nombres)`,
      tests: [{ type: "contains", expected: "fruits =" }],
    },
    {
      id: "s1_e57",
...
print(couleurs[1])
print(couleurs[-1])`,
      tests: [{ type: "contains", expected: "couleurs[0]" }],
    },
    {
      id: "s1_e58",
...
animaux[2] = "oiseau"
print(animaux)`,
      tests: [{ type: "contains", expected: "animaux[2] =" }],
    },
    {
      id: "s1_e59",
...
nombres.remove(2)
print(nombres)`,
      tests: [{ type: "contains", expected: ".remove(" }],
    },
    {
      id: "s1_e61",
...
print(len(courses))`,
      tests: [{ type: "contains", expected: "len(courses)" }],
    },
    {
      id: "s1_e62",
...
print(complete)`,
      tests: [{ type: "contains", expected: "partie1 + partie2" }],
    },
    {
      id: "s1_e63",
...
repete = motif * 3
print(repete)`,
      tests: [{ type: "contains", expected: "motif * 3" }],
    },
    {
      id: "s1_e64",
...
print(nombres[:3])
print(nombres[-3:])`,
      tests: [{ type: "contains", expected: "nombres[2:6]" }],
    },
    {
      id: "s1_e65",
...
print("lunettes" in inventaire)`,
      tests: [{ type: "contains", expected: " in inventaire" }],
    },
    {
      id: "s1_e66",
...
print(alphabet.index("e"))`,
      tests: [{ type: "contains", expected: ".index(" }],
    },
    {
      id: "s1_e67",
...
print(lettres.count("b"))`,
      tests: [{ type: "contains", expected: ".count(" }],
    },
    {
      id: "s1_e68",
...
sequence.reverse()
print(sequence)`,
      tests: [{ type: "contains", expected: ".reverse()" }],
    },
    {
      id: "s1_e69",
...
desordonne.sort()
print(desordonne)`,
      tests: [{ type: "contains", expected: ".sort()" }],
    },
    {
      id: "s1_e70",
...
print(original)
print(copie)`,
      tests: [{ type: "contains", expected: ".copy()" }],
    },
    {
      id: "s1_e71",
      title: "Liste vide",
...
panier.append("œufs")
print(panier)`,
      tests: [{ type: "contains", expected: "append(" }],
    },
    {
      id: "s1_e72",
...
liste.insert(1, "b")
print(liste)`,
      tests: [{ type: "contains", expected: ".insert(" }],
    },
    {
      id: "s1_e73",
...
print(supprime)
print(stack)`,
      tests: [{ type: "contains", expected: "stack.pop()" }],
    },
    {
      id: "s1_e74",
...
print(base)`,
      tests: [{ type: "contains", expected: ".extend(" }],
    },
    {
      id: "s1_e75",
...
print(donnees)
print(len(donnees))`,
      tests: [{ type: "contains", expected: ".clear()" }],
    },
  ];

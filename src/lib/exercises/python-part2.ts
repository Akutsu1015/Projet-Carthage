...
print(len(message))`,
      tests: [{ type: "contains", expected: "len(message)" }]
    },
    {
      id: "s1_e27",
...
print(mot[0])
print(mot[-1])`,
      tests: [{ type: "contains", expected: "mot[0]" }]
    },
    {
      id: "s1_e28",
...
print(phrase[:7])
print(phrase[8:])`,
      tests: [{ type: "contains", expected: "phrase[:7]" }]
    },
    {
      id: "s1_e29",
      title: "Concaténation",
...
print(nom_complet)`,
      tests: [{ type: "contains", expected: "prenom +" }]
    },
    {
      id: "s1_e30",
...
rire = motif * 5
print(rire)`,
      tests: [{ type: "contains", expected: "motif * 5" }]
    },
    {
      id: "s1_e31",
...
print(texte.upper())
print(texte.lower())`,
      tests: [{ type: "contains", expected: ".upper()" }]
    },
    {
      id: "s1_e32",
...
print(phrase.title())`,
      tests: [{ type: "contains", expected: ".capitalize()" }]
    },
    {
      id: "s1_e33",
...
print("gmail" in email)`,
      tests: [{ type: "contains", expected: " in email" }]
    },
    {
      id: "s1_e34",
      title: "Remplacement",
...
print(nouvelle_phrase)`,
      tests: [{ type: "contains", expected: ".replace(" }]
    },
    {
      id: "s1_e35",
...
print('"' + texte_propre + '"')`,
      tests: [{ type: "contains", expected: ".strip()" }]
    },
    {
      id: "s1_e36",
...
print(couleurs)`,
      tests: [{ type: "contains", expected: ".split(" }]
    },
    {
      id: "s1_e37",
...
phrase = " ".join(mots)
print(phrase)`,
      tests: [{ type: "contains", expected: ".join(" }]
    },
    {
      id: "s1_e38",
...
print(message)`,
      tests: [{ type: "contains", expected: ".format(" }]
    },
    {
      id: "s1_e39",
      title: "F-strings",
...
print(message)`,
      tests: [{ type: "code_match", expected: "f[\"']" }]
    },
    {
      id: "s1_e40",
...
`,
      ...
      tests: [{ type: "contains", expected: 'Il a dit: "Python est génial!"' }],
    },
...
print(a // b)
print(a % b)`,
      tests: [{ type: "contains", expected: "// b" }],
    },
    {
      id: "s1_e43",
      title: "Puissance",
...
`,
      solution: `print(2 ** 8)
print(3 ** 4)`,
      tests: [{ type: "contains", expected: "** 8" }]
    },
    {
      id: "s1_e44",
...
print((2 + 3) * 4)`,
      tests: [{ type: "contains", expected: "3 * 4" }]
    },
    {
      id: "s1_e45",
...
print(flottant)
print(type(entier))`,
      tests: [{ type: "contains", expected: "int(texte)" }]
    },
    {
      id: "s1_e47",
      title: "Arrondi",
...
print(round(nombre))`,
      tests: [{ type: "contains", expected: "round(" }]
    },
    {
      id: "s1_e48",
...
print(abs(negatif))
print(abs(positif))`,
      tests: [{ type: "contains", expected: "abs(" }]
    },
    {
      id: "s1_e49",
      title: "Min et Max",
...
print(max(5, 12, 3, 18, 7))`,
      tests: [{ type: "contains", expected: "min(" }],
    },
    {
      id: "s1_e50",
...
print(total)
print(moyenne)`,
      tests: [{ type: "contains", expected: "sum(" }]
    },
  ];

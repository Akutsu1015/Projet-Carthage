...
const exercises: Exercise[] = [
    // === DUOLINGO SYSTEM (Intro, Quiz, Puzzle) ===
    {
      ...
      description: "Le langage polyvalent et puissant.",
      content: "<p>Bienvenue dans votre formation <strong>Python</strong> ! Python est célèbre pour sa syntaxe simple et claire, très proche de l'anglais.</p><p>Que ce soit pour l'IA, la data, le développement web ou l'automatisation, Python est un choix incontournable pour les développeurs aujourd'hui.</p><p>Prêt à démarrer ?</p>",
      category: "Général",
      code_example: "print(\"Prêt ! \")\n# Voici comment on affiche un message en Python",
    },
    {
      id: "py_quiz_0",
      type: "quiz",
      title: "Tester vos connaissances",
      instruction: "Quelle est l'une des caractéristiques principales de Python ?",
      options: [
        "Il est très complexe à lire",
        "Sa syntaxe simple et claire, proche de l'anglais",
        "Il ne sert qu'à faire des jeux vidéo",
        "Il faut payer pour l'utiliser"
      ],
      correct: 1,
      explanation: "Exact ! Python a été conçu pour être facilement lisible, ce qui en fait un langage de choix pour débuter.",
      category: "Général",
    },
    {
      id: "py_puzzle_0",
      type: "puzzle",
      title: "Premier puzzle Python",
      instruction: "Remettez les morceaux en ordre pour afficher un message :",
      pieces: ["print", "(", "\"Hello !\"", ")"],
      hint: "Syntaxe : print(\"message\")",
      category: "Général",
    },
...
`,
      ...
      tests: [{ type: "contains", expected: "Hello, World!" }]
    },
    {
      id: "s1_e2",
...
`,
      ...
      tests: [{ type: "contains", expected: "Hello, Alice!" }]
    },
    {
      id: "s1_e3",
...
print("C'est génial!")`,
      tests: [{ type: "contains", expected: "Bonjour" }]
    },
    {
      id: "s1_e4",
      title: "Commentaires",
...
print("Les commentaires aident à comprendre")`,
      tests: [{ type: "contains", expected: "Python est facile" }]
    },
    {
      id: "s1_e5",
...
print('Python c\\'est super')`,
      tests: [{ type: "contains", expected: "Python c'est super" }]
    },
    {
      id: "s1_e6",
...
`,
      ...
      tests: [{ type: "contains", expected: "Première ligne" }]
    },
    {
      id: "s1_e7",
      title: "Tabulations",
...
print("2.\\tJavaScript")
print("3.\\tJava")`,
      tests: [{ type: "contains", expected: "1.\\tPython" }]
    },
    {
      id: "s1_e8",
...
`,
      ...
      tests: [{ type: "contains", expected: "sep=\"-\"" }]
    },
    {
      id: "s1_e9",
...
print("World")`,
      tests: [{ type: "contains", expected: "end=" }]
    },
    {
      id: "s1_e10",
...
`,
      solution: `nom = "Alice"
print(nom)`,
      tests: [{ type: "contains", expected: "Alice" }]
    },
    {
      id: "s1_e12",
...
`,
      solution: `age = 25
print(age)`,
      tests: [{ type: "contains", expected: "age = 25" }]
    },
    {
      id: "s1_e13",
...
print(age)
print(taille)`,
      tests: [{ type: "contains", expected: "Bob" }]
    },
    {
      id: "s1_e14",
      title: "Réassignation",
...
score = 20
print(score)`,
      tests: [{ type: "contains", expected: "score = 20" }]
    },
    {
      id: "s1_e15",
...
print(quantite_stock)`,
      tests: [{ type: "contains", expected: "Ordinateur" }]
    },
    {
      id: "s1_e16",
...
print(date_de_naissance)`,
      tests: [{ type: "contains", expected: "Jean" }]
    },
    {
      id: "s1_e17",
...
print(original)
print(copie)`,
      tests: [{ type: "contains", expected: "Python" }]
    },
    {
      id: "s1_e18",
...
print(a)
print(b)`,
      tests: [{ type: "contains", expected: "a, b = b, a" }]
    },
    {
      id: "s1_e19",
...
print(VITESSE_LUMIERE)`,
      tests: [{ type: "contains", expected: "PI = 3.14159" }]
    },
    {
      id: "s1_e20",
...
print(type(texte))
print(type(nombre))`,
      tests: [{ type: "contains", expected: "type(texte)" }]
    },
    {
      id: "s1_e21",
...
print(est_majeur)
print(a_permis)`,
      tests: [{ type: "contains", expected: "est_majeur = True" }]
    },
    {
      id: "s1_e22",
      title: "Variable None",
...
print(resultat)
print(type(resultat))`,
      tests: [{ type: "contains", expected: "resultat = None" }]
    },
    {
      id: "s1_e23",
...
print(VERSION)
print(AUTHOR)`,
      tests: [{ type: "contains", expected: "MonApp" }]
    },
    {
      id: "s1_e24",
...
print(y)
print(z)`,
      tests: [{ type: "contains", expected: "x, y, z = 1, 2, 3" }]
    },
    {
      id: "s1_e25",
...
print(b)
print(c)`,
      tests: [{ type: "contains", expected: "a = b = c = 0" }]
    },
  ];

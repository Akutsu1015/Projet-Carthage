...
const CATEGORY_CONFIG = {
    personnages: { label: "Guerriers de Lyoko", icon: Users, color: "#00d4ff" },
    monstres: { label: "Monstres de XANA", icon: Sword, color: "#ff2244" },
    vehicules: { label: "Véhicules", icon: Ship, color: "#00ff88" },
    lieux: { label: "Lieux & Objets", icon: Building2, color: "#fbbf24" },
};
        ...
        <div className="min-h-[calc(100vh-4rem)]">
            ...
            <div className="relative overflow-hidden border-b border-lyoko-blue/10 bg-gradient-to-br from-dark-surface via-dark-bg to-dark-surface py-12">
                ...
                <div className="relative z-10 mx-auto max-w-7xl px-4 text-center lg:px-8">
                    ...
                    <h1 className="font-display text-[clamp(1.5rem,4vw,3rem)] font-black uppercase tracking-wider text-white">
                        Galerie <span className="text-lyoko-blue">3D</span> Code Lyoko
                    </h1>
                    <p className="mx-auto mt-2 max-w-lg text-sm text-white/50">
                        Explorez les modèles 3D des personnages, monstres et véhicules du monde virtuel.
                        Débloquez-les en progressant dans vos exercices.
                    </p>
                    ...
                    <div className="mt-6 flex justify-center gap-6">
                        <div className="text-center">
                            ...
                            <p className="text-[0.65rem] text-white/40">Débloqués</p>
                        </div>
                        <div className="h-10 w-px bg-white/10" />
                        <div className="text-center">
                            <p className="font-display text-2xl font-black text-white/60">{MODELS.length}</p>
                            <p className="text-[0.65rem] text-white/40">Total</p>
                        </div>
                        <div className="h-10 w-px bg-white/10" />
                        <div className="text-center">
                            ...
                            <p className="text-[0.65rem] text-white/40">Votre niveau</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="mx-auto max-w-7xl px-4 py-8 lg:px-8">
                ...
                <div className="mb-6 flex flex-wrap gap-2">
                    ...
                    >
                        <Sparkles size={13} /> Tous ({MODELS.length})
                    </button>
                    {categories.map((cat) => {
                        ...
                        return (
                            ...
                            >
                                <Icon size={13} style={{ color: cfg.color }} /> {cfg.label} ({count})
                            </button>
                        );
                    })}
                </div>
                                            ...
                                            >
                                                    ...
                                                    {!isUnlocked && (
                                                        <div className="absolute inset-0 flex flex-col items-center justify-center bg-dark-bg/80">
                                                            ...
                                                            <span className="text-xs font-bold text-white/30">
                                                                Niveau {model.unlockLevel} requis
                                                            </span>
                                                        </div>
                                                    )}
                                                ...
                                                <div className="p-4">
                                                    ...
                                                    <p className="text-[0.7rem] leading-relaxed text-white/40">
                                                        {isUnlocked ? model.description : "Modèle verrouillé"}
                                                    </p>
                                                </div>
                                            </button>
                                        );
